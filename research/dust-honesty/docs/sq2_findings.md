...
**Date:** 2026-05-01.
**Inputs:** `operational/dbb_operational_sq2.csv` (228 rows = 3 AOIs × 76 months, 2020-01..2026-04), `operational/summary_stats_sq2.md`, `operational/cross_check_failures_sq2.csv`.
